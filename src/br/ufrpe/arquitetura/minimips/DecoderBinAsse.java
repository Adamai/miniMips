...
private String imediato;
	...
	public void verifop(String entrada){ // VERIFICA A OPERA��O 
		...
		if(this.tipo.equals("R")){    //INTRU�OES TIPO R
		...
		else if(tipo.equals("I")){ //INSTRU�OES TIPO I
	...
	public String verifReg(String entrada){ // CODIFICA OS REGISTRADORES
		...
		if(this.tipo.equals("R")){
			   r1= convertBin(entrada.substring(16, 21)); //resposta-> 4�seq
			   r2= convertBin(entrada.substring(6, 11)); //operador-> 2�seq
			   r3= convertBin(entrada.substring(11, 16)); //operador-> 3�seq
			   r4= convertBin(entrada.substring(21,26)); //operador especial-> 5�seq
			   result = r1 + ", "+ r2 + ", "+r3;
			switch(resultOP){
		...
		if(this.tipo.equals("I")){
			...
			case "addiu":result = "$" + r3 + ", " + "$" + r2+ ", "+ convertBin(imediato);
				break;
			case "beq": result = "$" + r3 + ", " + "$" + r2+ ", "+ "$" + r4;
				break;
			case "bne": result = "$" + r3 + ", " + "$" + r2+ ", "+ "$" + r4;
				break;
			case "bltz": result = "$" + r3 + ", " + "$" + r4;
				break;
